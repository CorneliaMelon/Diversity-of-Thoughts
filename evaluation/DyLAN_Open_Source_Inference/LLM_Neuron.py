...
TOGETHER_API_KEY = "56887c38f1ae9b38b9d885d8c32e542bdb649a2e30ae67e839962645dd421672"
...
class LLMNeuron:
    ...
    def activate(self, question):
        ...
        self.reply, self.prompt_tokens, self.completion_tokens = generate_answer(contexts, self.model, client)
        # parse answer
...
def listwise_ranker_2(responses, question, qtype, model="chatgpt0301"):
    ...
    completion, prompt_tokens, completion_tokens = generate_answer([message], model, client)
